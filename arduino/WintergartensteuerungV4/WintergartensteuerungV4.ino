...
// Output Pins
// Cover_ON, Cover_DOWN, ON_Time_Max
const int OUT_INFOS[MAX_COVERS] = {
   {10,12,16000},
   {11,13,16000}
 };
...
Wgs Cover[MAX_COVERS]= OUT_INFOS[MAX_COVERS];
...
const int MarkDown = 13; // activates relais 3+4
 */
bool UpStates[MAX_COVERS];
bool DownStates[MAX_COVERS];
bool ReverseStates[MAX_COVERS];
bool EmergencyState = 0;
 ...
 * über ein Array klarkäme
 */
Bounce debounce[MAX_COVERS][2]= Bounce();
/*Bounce debounceJalDown  = Bounce();
Bounce debounceMarkUp    = Bounce();
Bounce debounceMarkDown  = Bounce();*/
